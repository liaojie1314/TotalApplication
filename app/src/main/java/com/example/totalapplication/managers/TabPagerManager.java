...
public class TabPagerManager {
    ...
    public static FragmentViewPagerAdapter getPagerAdapter(FragmentManager fragmentManager) {
        return new FragmentViewPagerAdapter(fragmentManager);
    }
    ...
    public class TabPagerBuilder {
        ...
        public class TabPagerOption {
            ...
            private int unselectedTextSize = 17;
            private int selectedTextSize = 17;
            ...
            public TabPagerOption setTabTextSize(int unselectedTextSize, int selectedTextSize) {
            ...
            public TabPagerOption hideTabRipple(boolean hide) {
                if (hide) {
                    ColorStateList colorStateList = tabLayout.getContext().getResources()
                            .getColorStateList(R.color.transparent);
                    tabLayout.setTabRippleColor(colorStateList);
                }
                return this;
            }
