package com.example.totalapplication.customviews.keypad;
...
public class KeypadView extends ViewGroup {
    ...
    public static final int DEFAULT_MARGIN = AppSizeUtils.dip2px(2);
    ...
    private Drawable providerItemBg() {
        ...
        pressDrawable.setCornerRadius(AppSizeUtils.dip2px(5));
        ...
        normalDrawable.setCornerRadius(AppSizeUtils.dip2px(5));
