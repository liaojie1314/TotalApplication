package com.example.totalapplication.customviews.flow;
...
import com.example.totalapplication.Utils.AppSizeUtils;
...
public class FlowLayout extends ViewGroup {
    ...
    //后面转单位，目前是px不适配
    public static final int DEFAULT_HORIZONTAL_MARGIN = AppSizeUtils.dip2px(5f);
    public static final int DEFAULT_VERTICAL_MARGIN = AppSizeUtils.dip2px(5f);
    public static final int DEFAULT_BORDER_RADIUS = AppSizeUtils.dip2px(5f);
...
//        child1.layout(child.getRight(), 0, child.getRight() + child1.getMeasuredWidth(), child1.getMeasuredHeight());
    ...
    public void setHorizontalMargin(int horizontalMargin) {
        mHorizontalMargin = AppSizeUtils.dip2px(horizontalMargin);
    }
    ...
    public void setVerticalMargin(int verticalMargin) {
        mVerticalMargin = AppSizeUtils.dip2px(verticalMargin);
    }
