package com.example.totalapplication.customviews.imomoe;
...
import com.example.totalapplication.listeners.OnLimitClickListener;

import butterknife.BindView;
import butterknife.ButterKnife;

public class SearchTitleBar extends LinearLayout implements OnLimitClickInterface {
    ...
    private void builder(Context context) {
        ...
        searchLayout.setOnClickListener(new OnLimitClickListener(this));
    }
    ...
    public void setHint(String hint) {
        if (TextUtils.isEmpty(hint)) {
            ...
            searchEt.setPadding(ResourceAttributesUtils.getResourcesDimension(R.dimen.dimen_size_5), 0, 0, 0);
        }
