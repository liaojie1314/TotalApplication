...
/*使用
xml:
<com.example.totalapplication.customviews.waterwave.DropletBubbles
        android:layout_width="wrap_content"
        app:outRadius="30dp"
        app:innerRadius="25dp"
        app:backgroundColor="@android:color/white"
        app:waveColor="@color/colorWave"
        android:id="@+id/dbMainBubbles1"
...
public class DropletBubbles extends View {
    ...
    public DropletBubbles(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = typedArray.getColor(R.styleable.DropletBubbles_backgroundColor, getResources().getColor(R.color.colorPrimaryBubble));
        mWaveColor = typedArray.getColor(R.styleable.DropletBubbles_waveColor, getResources().getColor(R.color.colorAccentBubble));
        typedArray.recycle();
        init();//初始化画笔
    }
